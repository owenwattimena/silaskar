...
@section('page', 'Ubah Transaksi Barang Masuk')
        ...
        <div class="col-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Form Ubah Transaksi Barang Masuk</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="form" action="{{ route('incoming-product.put', $incomingProduct->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12 form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="date" id="created_at" name="created_at"
                                        value="{{ old('created_at') ?? date('Y-m-d', strtotime($incomingProduct->created_at)) }}"
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <select id="product_id" name="product_id" class="form-control select2" required>
                                        ...
                                        @foreach ($products as $product)
                                            <option {{ $incomingProduct->product_id == $product->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-12 form-group row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number" id="stock" name="stock"
                                        value="{{ old('stock') ?? $incomingProduct->stock_quantity }}"
