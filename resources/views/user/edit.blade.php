    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="form" action="{{ route('user.put', $user->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group row">
                                <label for="division" class="col-md-4">Bagian <sup class="text-danger">*</sup></label>
                                <div class="col-md-5">

                                    <select id="division" name="division" class="form-control select2" required>
                                        @foreach ($divisions as $division)
                                            <option {{ $division->id == $user->division_id ? 'selected' : '' }}
        ...
        <div class="col-md-4">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="form" action="{{ route('user.change-password', $user->id) }}" method="POST">
                        @csrf
                        @method('put')
